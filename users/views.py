            ...
            if error is not None:
                ...
                if username is not None:
                    ...
                    try:
                        ...
                        # if userdata is not, create userdata.
                    ...
                    raise GithubException("User doesn't exist")
        else:
            raise GithubException("Can't get code")
    except GithubException as e:
        # if user login is errored, redirect to home.
        # send error message
...
def kakao_callback(request):
    try:
        ...
        if code is not None:
            ...
            if email is None:
                raise KakaoException("Email doesn't exist")
...
class UserProfileView(DetailView):
    ...
    model = models.User
    # It is distinguished to logined user
    context_object_name = "user_obj"

    def get_context_data(self, **kwargs):
        """This method returns context data to each user's template"""
